...
Study_dates <- read_excel("../data/Study_dates_MeLiDos_MPI.xlsx",
                          col_types = c("numeric", "numeric", "numeric", "guess", "guess", "guess", "guess", "date", "text"))
...
save(data_export, file = "../data/imported/light/de_mpi_1minute.RData")
```
