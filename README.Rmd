...
*Note: this questionnaire is not available in the `GuidolinEtAl_2025` dataset.*
...
- `data/Metadata_Melidos_MPI.xlsx`: Preliminary Metadata prior to conversion to JSON
